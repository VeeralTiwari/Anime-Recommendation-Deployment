...
async function fetchData() {
    ...
    try {
        const response = await fetch('https://anime-server-rrxx.onrender.com/get-list', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
            body: JSON.stringify({ userId }) // Add userId to the body payload
        });
